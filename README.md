...
All widgets are shown at their canonical TRMNL 800×480 render. Screenshots are captured with [`bin/preview`](./bin/preview) and regenerated by hand when a widget changes meaningfully.

### [`agenda-calendar`](./agenda-calendar)

Dense agenda view of a Google Calendar with a two-week mini header. Scales to any e-ink canvas — reMarkable, Kindle Paperwhite, Kindle Scribe.

![agenda-calendar](./agenda-calendar/screenshot.png)

### [`google-calendar-week`](./google-calendar-week)

Weekly Google Calendar view for LaraPaper using a private iCal feed. Monday-to-Sunday timed grid with all-day strip.

![google-calendar-week](./google-calendar-week/screenshot.png)

### [`posthog-analytics`](./posthog-analytics)

PostHog analytics dashboards for e-ink displays: growth accounting, weekly active users, and a daily event count.

![posthog-analytics](./posthog-analytics/screenshot.png)

### [`yr-weather`](./yr-weather)

Norwegian weather forecast from MET.no with hourly chart, weather icons and "klestips" from OpenRouter.

![yr-weather](./yr-weather/screenshot.png)
